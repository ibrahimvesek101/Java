...
/*
    ...
    */
    ...
    String isim;    // ins obj. veriable
    int tecrube;    //ins. obj. veriable// ..
    static String okul; // herkesi bağlar.

    public C01_Ogretmen(String isim, int tecrube) { //full p li teleskobik cons.
   ...
   public static void maasHesapla() { // static method
    ...
    public void evlilikYıldonumu(){ // non static method.
        ...
        System.out.println("evlilik yıldonumu hayırlı olsun");
